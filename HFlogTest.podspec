...
Pod::Spec.new do |s|
  s.name             = 'HFlogTest'
  s.version          = '0.1.0'
  s.summary          = 'A short description of HFlogTest.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/492151779@qq.com/HFlogTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '492151779@qq.com' => 'shuzhen.hu@car2data.cn' }
  s.source           = { :git => 'https://github.com/492151779@qq.com/HFlogTest.git', :tag => s.version.to_s }
